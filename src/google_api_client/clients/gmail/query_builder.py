...
class EmailQueryBuilder:
    ...
    def in_date_range(self, start_date: datetime, end_date: datetime) -> "EmailQueryBuilder":
        """
    ...
    def after_date(self, date_obj: datetime) -> "EmailQueryBuilder":
        """
    ...
    def before_date(self, date_obj: datetime) -> "EmailQueryBuilder":
        """
