...
if TYPE_CHECKING:
    from .async_client import AsyncEmailMessage
...
class AsyncEmailQueryBuilder:
    """
    Builder pattern for constructing async Gmail queries with a fluent API.
    Provides a clean, readable way to build complex email queries asynchronously.
    ...
    def __init__(self, async_email_message_class):
        self._async_email_message_class = async_email_message_class
    ...
    def limit(self, count: int) -> "AsyncEmailQueryBuilder":
        """
    ...
    def search(self, query: str) -> "AsyncEmailQueryBuilder":
        """
    ...
    def from_sender(self, email: str) -> "AsyncEmailQueryBuilder":
        """
    ...
    def to_recipient(self, email: str) -> "AsyncEmailQueryBuilder":
        """
    ...
    def with_subject(self, subject: str) -> "AsyncEmailQueryBuilder":
        """
    ...
    def with_attachments(self) -> "AsyncEmailQueryBuilder":
        """
    ...
    def without_attachments(self) -> "AsyncEmailQueryBuilder":
        """
    ...
    def is_read(self) -> "AsyncEmailQueryBuilder":
        """
    ...
    def is_unread(self) -> "AsyncEmailQueryBuilder":
        """
    ...
    def is_starred(self) -> "AsyncEmailQueryBuilder":
        """
    ...
    def is_important(self) -> "AsyncEmailQueryBuilder":
        """
    ...
    def in_folder(self, folder: str) -> "AsyncEmailQueryBuilder":
        """
    ...
    def with_label(self, label: str) -> "AsyncEmailQueryBuilder":
        """
    ...
    def in_date_range(self, start_date: datetime, end_date: datetime) -> "AsyncEmailQueryBuilder":
        """
    ...
    def after_date(self, date_obj: datetime) -> "AsyncEmailQueryBuilder":
        """
    ...
    def before_date(self, date_obj: datetime) -> "AsyncEmailQueryBuilder":
        """
    ...
    def today(self) -> "AsyncEmailQueryBuilder":
        """
    ...
    def yesterday(self) -> "AsyncEmailQueryBuilder":
        """
    ...
    def last_days(self, days: int) -> "AsyncEmailQueryBuilder":
        """
    ...
    def this_week(self) -> "AsyncEmailQueryBuilder":
        """
        ...
        # This will give us the number of days from Monday to today
    ...
    def this_month(self) -> "AsyncEmailQueryBuilder":
        ...
        Returns:
            Self for method chaining
        """
        days_since_start_of_month = date.today().day # Days in current month
    ...
    def smaller_than(self, size_mb: int) -> "AsyncEmailQueryBuilder":
        """
    ...
    def include_spam_trash(self, include: bool = True) -> "AsyncEmailQueryBuilder":
        """
    ...
    def with_label_ids(self, label_ids: List[str]) -> "AsyncEmailQueryBuilder":
        """
    ...
    async def execute(self) -> List["AsyncEmailMessage"]:
        """
        Execute the query and return the results.
        Returns:
            List of AsyncEmailMessage objects matching the query
        """
        query_string = " ".join(self._query_parts) if self._query_parts else None
        
        logger.info("Executing async email query: %s", query_string)
        
        return await self._async_email_message_class.list_emails(
    ...
    async def first(self) -> Optional["AsyncEmailMessage"]:
        """
        Get the first email matching the query.
        Returns:
            First AsyncEmailMessage object or None if no matches
        """
        original_limit = self._max_results
        self._max_results = 1
    ...
    def __repr__(self):
        query_string = " ".join(self._query_parts) if self._query_parts else "None"
        return f"AsyncEmailQueryBuilder(query='{query_string}', limit={self._max_results})"