...
from src.google_api_client.clients.tasks.query_builder import TaskQueryBuilder
from src.google_api_client.clients.tasks.client import Task
...
class TestTaskQueryBuilder:
    """Test cases for the TaskQueryBuilder class."""
    
    def test_query_builder_initialization(self):
        """Test query builder initialization."""
        mock_task_class = Mock()
        builder = TaskQueryBuilder(mock_task_class)
        
        assert builder._task_class == mock_task_class
    ...
    @patch('src.google_api_client.clients.tasks.query_builder.date')
    ...
    def test_execute(self):
        ...
        mock_task_class._list_tasks_with_filters.return_value = mock_tasks
    ...
    def test_execute_with_date_filters(self):
        """Test executing query with date filters."""
        mock_task_class = Mock()
        mock_tasks = [Mock()]
        mock_task_class._list_tasks_with_filters.return_value = mock_tasks
    ...
    def test_first_no_results(self):
        ...
        mock_task_class = Mock()
        mock_task_class._list_tasks_with_filters.return_value = []
    ...
    def test_method_chaining(self):
        ...
        result = (TaskQueryBuilder(mock_task_class)
                 .limit(25)
