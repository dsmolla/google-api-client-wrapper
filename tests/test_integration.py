...
from google_client.calendar_client import CalendarEvent
from google_client.async_calendar_client import AsyncCalendarEvent
from utils.datetime_util import today_start, days_from_today
...
class TestCalendarIntegration:
    ...
    @patch('google_client.calendar_client.calendar_service')
...
class TestExceptionHandling:
    ...
    @patch('google_client.calendar_client.get_calendar_service')
    def test_calendar_permission_error_handling(self, mock_get_service):
        """Test handling of permission errors."""
        from googleapiclient.errors import HttpError
        from google_client.calendar_client import CalendarPermissionError
    ...
    def test_calendar_not_found_error_handling(self, mock_get_service):
        ...
        from googleapiclient.errors import HttpError
        from google_client.calendar_client import CalendarNotFoundError
    ...
    @pytest.mark.asyncio
    @patch('google_client.async_calendar_client.get_async_calendar_service')
    async def test_async_error_handling(self, mock_get_service):
        """Test async error handling."""
        from aiogoogle.excs import HTTPError
        from google_client.async_calendar_client import AsyncCalendarPermissionError
...
class TestTimezoneIntegration:
    ...
    def test_timezone_consistency_across_operations(self, sample_datetime, sample_datetime_end):
        ...
        from utils.datetime_util import today_start, today_end, days_from_today
